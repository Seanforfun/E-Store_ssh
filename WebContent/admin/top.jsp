	...
	<body>
		<table width="100%" height="70%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="100%" background="${pageContext.request.contextPath}/images/top_100.jpg" style="height: 15px; ">
				</td>
			</tr>
		</table>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="155" valign="bottom"
											background="${pageContext.request.contextPath}/images/mis_05b.jpg">
											Username:
											<s:property value="#session.userInfo.admin_name"/><!-- <font color="blue"></font> -->
										</td>
