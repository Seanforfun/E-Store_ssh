...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/jquery_004.js"></script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/jquery_003.js"></script>
<script type="text/javascript"
...
<body>
	...
	<div class="container productContent">
			...
			<div class="hotProductCategory">
				<s:iterator value="level1List" var="level1">
					<dl>
						<dt>
							<a
								href="${pageContext.request.contextPath }/product_findProductBylevel1_id?level1_id=<s:property value="#level1.level1_id"/>&pageNum=1"><s:property
									value="#level1.level1_name" /></a>
						</dt>
		...
		<div class="span18 last">
				...
				<a title="" style="outline-style: none; text-decoration: none;"
					...
					<div class="zoomPad">
						<img style="opacity: 1;" title="" class="medium"
							src="${pageContext.request.contextPath }/<s:property value='model.product_photo'/>">
						<div
			...
			<div class="name">
				<s:property value="model.product_name" />
			</div>
			<div class="sn">
				<div>
					serial number:
					<s:property value="model.product_id" />
				</div>
			</div>
			<div class="info">
				<dl>
					...
					<dd>
						...
						<del>
							$
							<s:property value="model.product_market_price" />
						</del>
					</dd>
				</dl>
				<dl>
					<dt>Discount:</dt>
					<dd>
						<a target="_blank" title=" flash sale(2014-07-30 ~ 2015-01-01)">
							flash sale</a>
					</dd>
				</dl>
				<dl>
			...
			<form action="${pageContext.request.contextPath }/cart_addProductToCart" method="get">
				<div class="action">
					<dl class="quantity">
						<dt>Number:</dt>
						<dd>
					...
					<div class="buy">
						<input id="addCart" class="addCart" value="Add to cart" type="submit">
					</div>
				</div>
			</form>
